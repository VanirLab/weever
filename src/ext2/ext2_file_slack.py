...
from weever.ext2.ext4_filesystem.EXT4 import EXT4


class Ext4FileSlackMetadata:
    """
    meta data class for ext2 Fileslack, holds addresses and length of saved data
    """
...
class EXT4FileSlack:
    """ class for ext2 fileslack operqations"""
