...
from weever.ext3.ext3_filesystem.EXT3 import EXT3


class Ext4FileSlackMetadata:
    """
    meta data class for ext3 Fileslack, holds addresses and length of saved data
    """
...
class EXT4FileSlack:
    """ class for ext3 fileslack operqations"""

    def __init__(self, stream: typ.BinaryIO, dev: str):
        """
        :param dev: path to an ext3 filesystem
        :param stream: filedescriptor of an ext3 filesystem
        """
        self.dev = dev
        self.stream = stream
